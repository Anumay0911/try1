<%@page import="com.example.demo.model.magazine"%>
...
<body>
	<table class="table table-hover table-dark">
	  <thead>
	    <tr>
	      <th scope="col">Magazine Thumbnail</th>
	...
	<%
		List<magazine> us=(List<magazine>) request.getAttribute("users");
		for(magazine u:us) {
	%>
	  <tbody>
	    <tr>
