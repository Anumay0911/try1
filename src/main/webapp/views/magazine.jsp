    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-6">
          <div class="card mt-5">
            <div class="card-body">
              <h1 class="card-title text-center mb-4">Magazine Donation</h1>
              <form method="post" action="/magazine/submit" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label for="isuueDate">Issue Date</label>
                  <input type="date" class="form-control" id="isuueDate" name="issueDate" required>
                </div>
                <div class="form-group">
